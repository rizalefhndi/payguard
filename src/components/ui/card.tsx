...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card relative flex flex-col gap-6 overflow-hidden rounded-[var(--radius-lg)] bg-white py-6 text-[14px] text-card-foreground shadow-[var(--shadow-card)] border-l-[3px] border-transparent border-l-[var(--color-primary-light)] has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-[var(--radius-lg)] *:[img:last-child]:rounded-b-[var(--radius-lg)] transition-all",
        className
      )}
      {...props}
    />
